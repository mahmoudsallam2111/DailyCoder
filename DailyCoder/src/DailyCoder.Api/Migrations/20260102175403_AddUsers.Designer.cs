...
namespace DailyCoder.Api.Migrations
{
    ...
    [Migration("20260102175403_AddUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyCoder.Api.Entities.Habit", b =>
                {
                    ...
                    b.ToTable("habits", "dev");
                });

            modelBuilder.Entity("DailyCoder.Api.Entities.HabitTag", b =>
                {
                    ...
                    b.ToTable("habit_tags", "dev");
                });

            modelBuilder.Entity("DailyCoder.Api.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DailyCoder.Api.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DailyCoder.Api.Entities.Habit", b =>
                {
                    b.OwnsOne("DailyCoder.Api.ValueObjects.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DailyCoder.Api.ValueObjects.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DailyCoder.Api.ValueObjects.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("DailyCoder.Api.Entities.HabitTag", b =>
                {
                    b.HasOne("DailyCoder.Api.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
                    ...
                    b.HasOne("DailyCoder.Api.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
